...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="Family Court",
                                                 font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))

        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, text="Incubation",
                                                        command=self.sidebar_button1_event)
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)

        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, text="Alimony",
                                                        command=self.sidebar_button2_event)
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)

        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, text="Restart", fg_color="#FF5D5D",
                                                        command=self.reset)
        self.sidebar_button_2.grid(row=9, column=0, padx=20, pady=10)

        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, text="Exit", fg_color="#FF5D5D",
    ...
    def sidebar_button2_event(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.button1_frame, text="Alimony",
                                                 font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.logo_label = customtkinter.CTkLabel(self.ans1_frame, text="Answer",
                                                 font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                        text="Does the mother have the incubation?")
        self.label_radio_group.grid(row=1, column=1, columnspan=1, padx=10, pady=10, sticky="")
        self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                           variable=self.radio_var, value=1, command=self.q1_ans)
        self.radio_button_1.grid(row=1, column=2, pady=10, padx=5, sticky="n")
        self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                           variable=self.radio_var, value=2, command=self.q1_ans)
        self.radio_button_2.grid(row=1, column=3, pady=10, padx=5, sticky="n")

        self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                        text="Is the child under 2 years?")
        self.label_radio_group.grid(row=2, column=1, columnspan=1, padx=10, pady=10, sticky="")
        self.radio_button_7 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                           variable=self.radio_var1, value=1, command=self.q1_ans)
        self.radio_button_7.grid(row=2, column=2, pady=10, padx=5, sticky="n")
        self.radio_button_8 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                           variable=self.radio_var1, value=2, command=self.q1_ans)
        self.radio_button_8.grid(row=2, column=3, pady=10, padx=5, sticky="n")

        self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                        text="is the wife staying in the house?")
        self.label_radio_group.grid(row=3, column=1, columnspan=1, padx=10, pady=10, sticky="")
        self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                           variable=self.radio_var2, value=1, command=self.q1_ans)
        self.radio_button_1.grid(row=3, column=2, pady=10, padx=5, sticky="n")
        self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                           variable=self.radio_var2, value=2, command=self.q1_ans)
        self.radio_button_2.grid(row=3, column=3, pady=10, padx=5, sticky="n")

        self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                        text="Is the husband rich enough to pay a servant?")
        self.label_radio_group.grid(row=4, column=1, columnspan=1, padx=10, pady=10, sticky="")
        self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                           variable=self.radio_var3, value=1, command=self.q1_ans)
        self.radio_button_1.grid(row=4, column=2, pady=10, padx=5, sticky="n")
        self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                           variable=self.radio_var3, value=2, command=self.q1_ans)
        self.radio_button_2.grid(row=4, column=3, pady=10, padx=5, sticky="n")

        self.scaling_label = customtkinter.CTkLabel(self.radiobutton_frame, text="What is the kind of divorce?",
                                                    anchor="w")
        self.scaling_label.grid(row=5, column=1, padx=20, pady=(10, 0))
        self.scaling_optionemenu = customtkinter.CTkOptionMenu(self.radiobutton_frame,
                                                               values=[" ", "Normal divorce", "Divorced for harm",
                                                                       "Wife divorced the Husband",
                                                                       "None of the above", ],
    ...
    def sidebar_button1_event(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.button1_frame, text="Incubation",
                                                 font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=1, padx=20, pady=(20, 10))
        ...
        self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                        text="Do you have a girl under 17 or a boy under 15?")
        self.label_radio_group.grid(row=1, column=1, columnspan=1, padx=10, pady=10, sticky="")
        self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                           variable=self.radio_var, value=1, command=self.q2_ans)
        self.radio_button_1.grid(row=1, column=2, pady=10, padx=5, sticky="n")
        self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                           variable=self.radio_var, value=2, command=self.q2_ans)
        self.radio_button_2.grid(row=1, column=3, pady=10, padx=5, sticky="n")
    ...
    def q1_ans(self):
        ...
        if ((str(self.radio_var.get())) == "1"):
            self.logo_label = customtkinter.CTkLabel(self.ans2_frame,
                                                     text="husband will pay money for kids incubation \nhusband will pay money for kids to live a suitable life")
    ...
    def divorce_handle(self):
        ...
        if ((str(self.radio_var4.get())) == "2"):
            self.logo_label = customtkinter.CTkLabel(self.ans3_frame,
                                                     text="husband pay 24 month expense of the monthly aliment\nhusband pay 3 month expense of the monthly aliment")
        ...
        if ((str(self.radio_var6.get())) == "2"):
            self.logo_label = customtkinter.CTkLabel(self.ans3_frame,
                                                     text="husband pay expense from 2 to 5 years of the monthly aliment\nhusband pay 3 month expense of the monthly aliment")
            self.logo_label.grid(row=5, column=2, padx=20, pady=(20, 10))
    ...
    def father_state(self):
        if ((str(self.radio_var2.get())) == "2"):
            ...
            self.logo_label = customtkinter.CTkLabel(self.radiobutton_frame, text="Mother's mother check",
                                                     text_color="#FBE4C9",
                                                     font=customtkinter.CTkFont(size=20, weight="bold"))
            self.logo_label.grid(row=0, column=1, padx=20, pady=(20, 10))

            self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                            text="If mother's mother not alive or alive suffering from any of these enter y if not enter n\n1- she is insane\n2- she is proven cheating on her husband\n3- she will travel outside the country and take the kids\n4- she is married to a stranger from the child\n5- she did practice professions that violate religion and the law\n6- She is not trusted, such as if she frequently go out and leave the child alone?")
            self.label_radio_group.grid(row=1, column=1, columnspan=1, padx=10, pady=10, sticky="")

            self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                               variable=self.radio_var3, value=1,
                                                               command=self.mothermother_state)
            self.radio_button_1.grid(row=1, column=2, pady=10, padx=20, sticky="n")
            self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                               variable=self.radio_var3, value=2,
                                                               command=self.mothermother_state)
            self.radio_button_2.grid(row=1, column=3, pady=10, padx=5, sticky="n")
    ...
    def mothermother_state(self):
        if ((str(self.radio_var3.get())) == "2"):
            ...
            self.ans2_frame.grid_rowconfigure(10, weight=1)
            self.logo_label = customtkinter.CTkLabel(self.ans2_frame,
                                                     text="the mother's mother will have the incubation")
            self.logo_label.grid(row=1, column=2, padx=20, pady=(20, 10))
        else:
            self.radiobutton_frame = customtkinter.CTkFrame(self.button1_frame)
            self.radiobutton_frame.grid(row=1, column=1, padx=(20, 20), pady=(20, 0), sticky="nsew")

            self.logo_label = customtkinter.CTkLabel(self.radiobutton_frame, text="Father's mother check",
                                                     text_color="#FBE4C9",
                                                     font=customtkinter.CTkFont(size=20, weight="bold"))
            self.logo_label.grid(row=0, column=1, padx=20, pady=(20, 10))

            self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                            text="If father's mother not alive or alive suffering from any of these enter y if not enter n\n1- she is insane\n2- she is proven cheating on her husband\n3- she will travel outside the country and take the kids\n4- she is married to a stranger from the child\n5- she did practice professions that violate religion and the law\n6- She is not trusted, such as if she frequently go out and leave the child alone?")
            self.label_radio_group.grid(row=1, column=1, columnspan=1, padx=10, pady=10, sticky="")

            self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                               variable=self.radio_var4, value=1,
                                                               command=self.fathermother_state)
            self.radio_button_1.grid(row=1, column=2, pady=10, padx=20, sticky="n")
            self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                               variable=self.radio_var4, value=2,
                                                               command=self.fathermother_state)
            self.radio_button_2.grid(row=1, column=3, pady=10, padx=5, sticky="n")
    ...
    def fathermother_state(self):
        if ((str(self.radio_var4.get())) == "2"):
            ...
            self.ans2_frame.grid_rowconfigure(10, weight=1)
            self.logo_label = customtkinter.CTkLabel(self.ans2_frame,
                                                     text="the father's mother will have the incubation")
            self.logo_label.grid(row=1, column=2, padx=20, pady=(20, 10))
        else:
            self.radiobutton_frame = customtkinter.CTkFrame(self.button1_frame)
            self.radiobutton_frame.grid(row=1, column=1, padx=(20, 20), pady=(20, 0), sticky="nsew")

            self.logo_label = customtkinter.CTkLabel(self.radiobutton_frame, text="Mother's sister check",
                                                     text_color="#FBE4C9",
                                                     font=customtkinter.CTkFont(size=20, weight="bold"))
            self.logo_label.grid(row=0, column=1, padx=20, pady=(20, 10))

            self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                            text="If mother's sister not alive or alive suffering from any of these enter y if not enter n\n1- she is insane\n2- she is proven cheating on her husband\n3- she will travel outside the country and take the kids\n4- she is married to a stranger from the child\n5- she did practice professions that violate religion and the law\n6- She is not trusted, such as if she frequently go out and leave the child alone?")
            self.label_radio_group.grid(row=1, column=1, columnspan=1, padx=10, pady=10, sticky="")

            self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                               variable=self.radio_var5, value=1,
                                                               command=self.mothersister_state)
            self.radio_button_1.grid(row=1, column=2, pady=10, padx=20, sticky="n")
            self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                               variable=self.radio_var5, value=2,
                                                               command=self.mothersister_state)
            self.radio_button_2.grid(row=1, column=3, pady=10, padx=5, sticky="n")
    ...
    def mothersister_state(self):
        if ((str(self.radio_var5.get())) == "2"):
            ...
            self.ans2_frame.grid_rowconfigure(10, weight=1)
            self.logo_label = customtkinter.CTkLabel(self.ans2_frame,
                                                     text="the mother's sister will have the incubation")
            self.logo_label.grid(row=1, column=2, padx=20, pady=(20, 10))
        else:
            self.radiobutton_frame = customtkinter.CTkFrame(self.button1_frame)
            self.radiobutton_frame.grid(row=1, column=1, padx=(20, 20), pady=(20, 0), sticky="nsew")

            self.logo_label = customtkinter.CTkLabel(self.radiobutton_frame, text="Father's sister check",
                                                     text_color="#FBE4C9",
                                                     font=customtkinter.CTkFont(size=20, weight="bold"))
            self.logo_label.grid(row=0, column=1, padx=20, pady=(20, 10))

            self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                            text="If father's sister not alive or alive suffering from any of these enter y if not enter n\n1- she is insane\n2- she is proven cheating on her husband\n3- she will travel outside the country and take the kids\n4- she is married to a stranger from the child\n5- she did practice professions that violate religion and the law\n6- She is not trusted, such as if she frequently go out and leave the child alone?")
            self.label_radio_group.grid(row=1, column=1, columnspan=1, padx=10, pady=10, sticky="")

            self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="true",
                                                               variable=self.radio_var6, value=1,
                                                               command=self.fathersister_state)
            self.radio_button_1.grid(row=1, column=2, pady=10, padx=20, sticky="n")
            self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="False",
                                                               variable=self.radio_var6, value=2,
                                                               command=self.fathersister_state)
            self.radio_button_2.grid(row=1, column=3, pady=10, padx=5, sticky="n")
    ...
    def fathersister_state(self):
        if ((str(self.radio_var6.get())) == "2"):
            ...
            self.ans2_frame.grid_rowconfigure(10, weight=1)
            self.logo_label = customtkinter.CTkLabel(self.ans2_frame,
                                                     text="the father's sister will have the incubation")
            self.logo_label.grid(row=1, column=2, padx=20, pady=(20, 10))
        else:
            self.ans2_frame = customtkinter.CTkFrame(self.ans1_frame, width=140, corner_radius=0)
            self.ans2_frame.grid(row=1, column=2, rowspan=4, sticky="nsew")
            self.ans2_frame.grid_rowconfigure(10, weight=1)
            self.logo_label = customtkinter.CTkLabel(self.ans2_frame, text="the child will go to a shelter",
                                                     text_color="#FF5D5D")
            self.logo_label.grid(row=1, column=2, padx=20, pady=(20, 10))
    ...
    def divorce_ans(self, divorce_type: str):
        if (divorce_type == "Normal divorce"):
            ...
            self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame,
                                                            text="Is the after divorce money in the marriage contract?")
            ...
            self.ans3_frame.grid_rowconfigure(10, weight=1)
            self.logo_label = customtkinter.CTkLabel(self.ans3_frame,
                                                     text="the wife will give up on all her rights\nthe wife will give husband money before marriage back",
                                                     text_color="#FF5D5D",
            ...
            self.ans3_frame.grid(row=6, column=2, rowspan=4, sticky="nsew")
            self.ans3_frame.grid_rowconfigure(10, weight=1)
            self.logo_label = customtkinter.CTkLabel(self.ans3_frame, text="That's impossible", text_color="#FF5D5D",
                                                     font=customtkinter.CTkFont(size=12, weight="bold"))
            self.logo_label.grid(row=6, column=2, padx=20, pady=(20, 10))
